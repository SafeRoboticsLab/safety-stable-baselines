...
if __name__ == "__main__":
    # ---------- argument parsing ----------
    parser = argparse.ArgumentParser(description="Train SAC with SafetySAC1P rollout filter on CarCircle")
    ...
    ckpt_cb = CheckpointCallback(
        save_freq=10_000,
        save_path=ckpt_dir,
        name_prefix="sac_car_circle2_withrolloutfilter",
    ...
    # ---------- final save ----------
    final_path = os.path.join(final_dir, f"car_circle2_sac_withrolloutfilter_h{HORIZON}_vt{VELOCITY_THRESHOLD}")
