...
if __name__ == "__main__":
    # ---------- argument parsing ----------
    parser = argparse.ArgumentParser(description="Train PPO with SafetySAC1P rollout filter on CarCircle")
    ...
    # ---------- model ----------
    # Standard PPO (same as naive training) with SafetySAC1P rollout filter
    model = PPO(
        policy="MlpPolicy",
        env=env,
