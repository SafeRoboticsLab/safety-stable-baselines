...
if __name__ == "__main__":
    # ---------- argument parsing ----------
    parser = argparse.ArgumentParser(description="Train SAC on CarGoal1 (naive, no safety filter)")
    ...
    eval_env = safety_gymnasium.make("SafetyCarGoal1-v0")
    ...
    # ---------- final save ----------
    final_path = os.path.join(final_dir, "car_goal1_sac")
